    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="https://pkba.vertiflow.fr/" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:opacity-80 transition-opacity">
              <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="https://reciproq.com/" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:opacity-80 transition-opacity">
              <Image
                src="/reciproq.png"
